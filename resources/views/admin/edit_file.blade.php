            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    <h3 class=" panel-heading">
                        ...
                        <div class="col-md-offset-3">Fichier Uploadé par <strong><?= htmlspecialchars($user->username) ?></strong> </div>
                    </h3>
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" role="form"  action="{{ url('/uploads/' . $uploads->id_upload) }}" method="POST">
                            ...
                            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="name" type="text" class="form-control" name="name" placeholder="Changer le nom du fichier">
